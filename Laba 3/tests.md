...
**Шаг** | **Ожидаемый результат**
В левом нижнем углу нажать на кнопку с типом графика | Откроется меню выбора типа графика
Переключиться на режим "Бады" | Изменение отображения цены акции (в окне трейда) на режим "Бады"
...
Нажать на кнопку "удаления акции" в списке быстрого доступа (в верхнем правом углу кнопки "Ethereum") | Из списка быстрого доступа удалиться акция "Ethereum"